...
from .views import SignupView, LoginView, Verify2FAView, RecoverPasswordView, ResetPasswordView, test_cache, suggest_email
...
urlpatterns = [
    ...
    path('suggest-email/', suggest_email, name='suggest_email'),
]
