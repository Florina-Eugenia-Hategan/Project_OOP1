...
### 2. **Creating Azure Resources for Django Backend**
   - Create an Azure App Service:
     - Navigate to "App Services".
     - Click "Create" and select "Web App".
     - Provide a name (e.g., `django-backend-app`).
     - Choose runtime stack: `Python 3.11`.
...
### 8. **Adding a Post-Build Script for Database Migrations**
   - Include the following in the YAML file:
     ```yaml
...
These are the steps followed to migrate and configure the necessary services in the project, so that all components work correctly.
